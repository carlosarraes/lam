...
try {
  ...
  const table = `<table><caption>Article bundle</caption><thead><tr><th scope="col">File</th><th scope="col">Reader behavior</th></tr></thead><tbody><tr><th scope="row">show-me.html</th><td>Static report</td></tr><tr><th scope="row">chart.png</th><td>Inline image</td></tr><tr><th scope="row">notes.txt</th><td>Save attachment</td></tr></tbody></table>`;
...
table{width:100%;border-collapse:collapse;background:white;margin:24px 0}caption{text-align:left;font-weight:700;margin-bottom:8px}th,td{text-align:left;padding:8px;border:1px solid #ccd5df}thead{background:#e6eef7}
</style></head><body><main><h1 id="top">Show-me delivery report</h1><p>Selectable article text</p><p>Prepare a static report, publish its explicit bundle, and read it in LAM.</p><figure>${svg}<figcaption>Mermaid 11.17.0, SVG text labels and resolved static paint.</figcaption></figure>${table}<figure><img src="chart.png" width="240" height="96" alt="Bundled chart"><figcaption>A bundled PNG stays inside the Article.</figcaption></figure><div class="background">Background image</div><details><summary>Expand details</summary><p>Details revealed</p></details><p><a href="#end">Jump to end</a> <a href="__CANARY_ORIGIN__/explicit">Visit external canary</a> <a href="notes.txt">Notes attachment</a></p><div style="height:900px"></div><h2 id="end">End of article</h2></main></body></html>\n`;
